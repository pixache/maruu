// Modüller eklendi.
// Komut mesajları özelleştirildi.
// Bot-Bilgi özelleştirildi.
...
module.exports.run = async(client, message, args) => {
    ...
    let bilgi = new Discord.RichEmbed()
        ...
        .setTimestamp()
        .setFooter(`${message.author.username} tarafından istedi.`, client.user.avatarURL);
